...
AI_PROVIDER_URL = os.getenv("AI_PROVIDER_URL", "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyCicLiLsmCHvvAQnDihgJ3ZL5b84WHZjvg")
